...
- `PYTHONPATH=src python3 -m overseer.cli serve-api --store state/overseer.sqlite3 --host 127.0.0.1 --port 8766` - serve the localhost-only HTTP API for state, health, and claim operations.
