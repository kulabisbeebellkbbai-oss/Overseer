...
3. Add richer event filters and approval review commands.
4. Add lease expiry and stale-claim cleanup.
5. Add foreground-to-daemon migration only after an explicit operator approval plan.
