...
from .storage_control import stage_authorization,list_authorizations,materialize_authorization,revoke_authorization
def main(argv=None):
    ...
    else: result=revoke_authorization(a.store,a.authorization_ref,a.revoked_by,a.evidence_id)
