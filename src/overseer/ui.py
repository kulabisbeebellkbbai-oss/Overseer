    ...
    function renderClaims() {
      ...
      document.getElementById("claims").innerHTML = `
        <div class="grid">
          ...
          <div class="panel span-12">${table("Runtime Provider Inventory", virtualEvidence.runtime_inventory || [], ["provider", "resource_id", "kind", "state", "image", "ports", "next_step"], {fills: {resource_id: (row) => resourceClaimFill(row.resource_id, "dax")}, fillView: "claims"})}</div>
