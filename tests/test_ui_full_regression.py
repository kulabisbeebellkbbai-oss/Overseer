...
ACTION_ROUTES = {
    ...
    "approve-and-execute-admin-change": ("POST", "/admin/execute"),
    ...
    "advance-odo-security": ("POST", "/host/security/advance"),
    ...
    "record-remote-testing-profile": ("POST", "/usage/remote-testing/profiles"),
    "request-remote-testing-lease": ("POST", "/usage/remote-testing/leases"),
    "enqueue-remote-test-job": ("POST", "/usage/remote-testing/jobs"),
    "collect-remote-test-results": ("POST", "/usage/remote-testing/results"),
...
SAFE_POST_PAYLOADS = {
    ...
    "/usage/remote-testing/profiles": {"profile_id": "remote-testing.tank-msi", "recorded_by": "quark"},
    "/usage/remote-testing/leases": {
        "lease_id": "lease.ui.full",
        "project": "Overseer",
        "purpose": "exercise disposable remote testing lease workflow",
        "requested_by": "quark",
        "job_types": ["ping"],
    },
    "/usage/remote-testing/jobs": {
        "lease_id": "lease.ui.full",
        "job_type": "ping",
        "requested_by": "quark",
        "project": "Overseer",
    ...
    "/usage/remote-testing/results": {"lease_id": "lease.ui.full"},
    "/health-targets": {
...
class FullOperatorUiRegressionTests(unittest.TestCase):
    ...
    def test_dashboard_drilldown_and_source_link_controls_are_present(self):
        ...
        self.assertIn("storage_mount_test", OPERATOR_CONSOLE_HTML)
        self.assertIn("compose_scan_image", OPERATOR_CONSOLE_HTML)
        self.assertIn("admin-mount-path", OPERATOR_CONSOLE_HTML)
        self.assertIn("admin-credential-file", OPERATOR_CONSOLE_HTML)
        self.assertIn("admin-filesystem-type", OPERATOR_CONSOLE_HTML)
